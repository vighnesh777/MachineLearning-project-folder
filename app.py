...
def processing_data(file):
    try:
        ...
        return None,None,None,None,"Default file 'diabetes_data_upload.csv' not foud"
...
if uploaded_file is not None:
    ...
    data_source = "diabetes_data_upload.csv"
    source_label = "Default Dataset"

X_train , X_test, y_train , y_test, error = processing_data(data_source)
if error:
    sl.error(error)
else:
